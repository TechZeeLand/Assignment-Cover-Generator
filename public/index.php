    ...
    <form id="main-form" class="panel form-panel" action="generate.php" method="post" target="_blank" novalidate>
        ...
        <section class="card">
            ...
            <details class="font-upload">
                <summary>➕ Add a custom font (shared with everyone)</summary>
        ...
        <section class="card">
            ...
            <input type="text" class="text-input" name="versity" id="versity" placeholder="Enter university name" value="Bangladesh Islami University">

            <label class="row-check">
                <input type="checkbox" name="show-dept-name" id="show-dept-name" checked>
                <span>Department name</span>
            </label>
            <input type="text" class="text-input" name="dept-name" id="dept-name" placeholder="Enter department" value="Department of English">
        ...
        <section class="card">
            ...
            <input type="text" class="text-input" name="student-name" id="student-name" placeholder="Enter student name" value="Rahyana Nuran">

            <label class="row-check"><input type="checkbox" name="show-student-id" id="show-student-id" checked><span>ID</span></label>
            <input type="text" class="text-input" name="student-id" id="student-id" placeholder="Enter student ID" value="BAERF53251003">
            ...
            <input type="text" class="text-input" name="student-section" id="student-section" placeholder="Enter section" value="Female">

            <label class="row-check"><input type="checkbox" name="show-student-batch" id="show-student-batch" checked><span>Batch</span></label>
            <input type="text" class="text-input" name="student-batch" id="student-batch" placeholder="Enter batch" value="53rd">
            ...
            <input type="text" class="text-input" name="student-program" id="student-program" placeholder="Enter program" value="BA (Hons)">
            ...
            <input type="text" class="text-input" name="semester" id="semester" placeholder="e.g. Summer" value="Summer">
        </section>
        ...
        <button type="submit" class="btn btn-primary btn-generate">⬇️ Generate PDF</button>
    </form>
...
<footer class="site-footer">
    <p>Assignment Cover Generator — free &amp; open source under the <a href="https://www.gnu.org/licenses/agpl-3.0.html" target="_blank" rel="noopener">AGPL-3.0</a> license.</p>
</footer>
